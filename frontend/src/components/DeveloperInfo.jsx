        ...
        >
            ...
            >
                ...
                <p className="text-gray-600 leading-relaxed">
                    ...
                    It achieves this by integrating sales projections (historical and future), Units Through Put (UTP) data,
                ...
                <div className="grid md:grid-cols-2 lg:grid-cols-4 gap-6">
                    {[
                        ...
                        },
                        {
                            ...
                            title: "Database",
                            items: ["MongoDB", "MongoDB Atlas (Cloud Hosting)", "Mongoose Schemas"]
                        },
                        {
                ...
                <div className="grid md:grid-cols-2 gap-x-8 gap-y-6">
                    <div>
                        ...
                        <ul className="space-y-1 text-sm text-gray-600 list-disc list-inside">
                            ...
                            <li><code className="text-xs bg-gray-100 px-1 rounded">/api/upt</code>: UTP data management (<code className="text-xs">salesData.controller.js</code>)</li>
                    ...
                    <div>
                        ...
                        <ul className="space-y-1 text-sm text-gray-600 list-disc list-inside">
                            ...
                            <li><code className="text-xs bg-gray-100 px-1 rounded">useCalculateThawingData</code> (in ThawingCabinet): Core hook using sales config, projections, UTPs, global buffers.</li>
                            <li><code className="text-xs bg-gray-100 px-1 rounded">useCalculatePrepData</code> (in PrepAllocations): Core hook using projections, UTPs, daily/global buffers, drink multiplier.</li>
                        </ul>
                    </div>
                </div>
            </motion.section>
                ...
                <div className="space-y-4">
                    <div>
                        ...
                        <p className="text-sm text-gray-600 leading-relaxed">
                            ...
                            It then calculates needed cases/bags using the source sales, product UTP, product-specific divisor, and global buffer percentage. Manual adjustments (non-`[PREP]`) are applied. Results shown in <code className="text-xs">DayCard</code>.
                        </p>
                    </div>
                    <div>
                        ...
                        <p className="text-sm text-gray-600 leading-relaxed">
                            ...
                            It calculates needed pans/buckets using the target sales, product UTP, product-specific divisor/formula, and buffer percentage (prioritizing *daily* buffers over global ones). A drink multiplier (0.75 Mon-Fri, 1.0 Sat) is used for lemonades. Manual adjustments tagged `[PREP]` are applied. Results shown in <code className="text-xs">DayCard</code>.
                        </p>
                    </div>
                    <div>
